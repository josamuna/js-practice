...
let isThereDepartmentWithEmployeesEarningMore5000 = employees.filter(
  (employee) => {
    return employee.departmentId === 2 && employee.salary > 5000;
  }
);
// let iter = 0;
// for (const department of departments) {
//   //   console.log(department);
//   isThereDepartmentWithEmployeesEarningMore5000[iter].pop = employees.every(
//     (employee) => {
//       return department.id === employee.departmentId && employee.salary > 5000;
//     }
//   );
//   iter++;
// }

// const isThereDepartmentWithEmployeesEarningMore5000 = departments.some(
//   (department) => {
//     return (
//       department &&
//       employees.every((employee) => {
//         return (
//           department.id === employee.departmentId && employee.salary > 5000
//         );
//       })
//     );
//   }
...
console.log(
  ...
  isThereDepartmentWithEmployeesEarningMore5000
);
...
// const groupByOccurence = Object.groupBy(arr5, (value) => value);
